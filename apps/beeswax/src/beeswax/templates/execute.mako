      ...
      <form id="advancedSettingsForm" action="${action}" method="POST" class="form form-horizontal">
        <div class="sidebar-nav">
          <ul class="nav nav-list">
            ...
            <li class="white">
              <select data-bind="options: databases, selectedOptions: database" class="input-medium" name="query-database"></select>
            </li>
            ...
            <li class="white">
              ...
              <div class="param">
                  ...
                  <div class="control-group">
                    <label>${_('Key')}</label>
                    <input type="text" class="settingsField span8" autocomplete="off" placeholder="mapred.reduce.tasks" />
                  </div>

                  <div class="control-group">
                    <label>${_('Value')}</label>
                    <input type="text" class="span8" placeholder="1" />
                  </div>
              </div>
              <!-- /ko -->

              <div class="control-group">
                <a data-bind="click: $root.addSetting" class="btn btn-small">${_('Add')}</a>
              </div>
            </li>
            <li class="nav-header
              % if app_name == 'impala':
            ...
            <li class="white
              ...
              <div class="param">
                  ...
                  <div class="control-group">
                    <label>${_('Path')}</label>
                    <input type="text" class="input-medium file_resourcesField pathChooser" placeholder="/user/foo/udf.jar" />
                  </div>
              </div>
              <!-- /ko -->

              <div class="control-group">
                <a data-bind="click: $root.addFileResources" class="btn btn-small">${_('Add')}</a>
              </div>
            </li>
            <li class="nav-header
            % if app_name == 'impala':
            ...
            ">
              ...
              <div class="param">
                  ...
                  <div class="control-group">
                    <label>${_('Name')}</label>
                    <input type="text" class="functionsField span8" autocomplete="off" placeholder="myFunction" />
                  </div>

                  <div class="control-group">
                    <label>${_('Class name')}</label>
                    <input type="text" class="span8" placeholder="com.acme.example" />
                  </div>
              </div>
              <!-- /ko -->

              <div class="control-group">
                <a data-bind="click: $root.addFunction" class="btn btn-small">${_('Add')}</a>
              </div>
            </li>
